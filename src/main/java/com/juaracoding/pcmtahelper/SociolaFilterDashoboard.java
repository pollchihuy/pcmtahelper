...
public class SociolaFilterDashoboard {
    ...
    public SociolaFilterDashoboard() {
...
//        delay(1);
        linkMenuDashboard.click();
        delay(1);
//        datePeriodeAwal.sendKeys("02/06/2024");
        datePeriodeAwal.sendKeys("2024-03-02");
        //input[@name='start_date']
        delay(1);
        datePeriodeAkhir.sendKeys("2024-05-29");
        delay(1);
